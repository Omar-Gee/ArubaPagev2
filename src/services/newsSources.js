...
export const arubaNative = `https://arubanative.com/wp-json/wp/v2/posts`;//-
...
export const sports = `http://www.297sports.com/wp-json/wp/v2/posts`;//-
export const solo = `http://solodipueblo.com//wp-json/wp/v2/posts?_embed&per_page=${articleCount}`;//-


const services = {
    arubaNative,aweMainta,_24ora,masNoticia,diario,focus,batiBleki,bonDia,sports,solo //,awe24,noticiaCla
}
